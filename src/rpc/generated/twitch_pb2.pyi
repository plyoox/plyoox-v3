...
class TwitchOfflineNotification(_message.Message):
    __slots__ = ("stream_id", "guild_id")
    STREAM_ID_FIELD_NUMBER: _ClassVar[int]
    GUILD_ID_FIELD_NUMBER: _ClassVar[int]
    stream_id: int
    guild_id: int
    def __init__(self, stream_id: _Optional[int] = ..., guild_id: _Optional[int] = ...) -> None: ...

class AddTwitchNotification(_message.Message):
    __slots__ = ("guild_id", "name", "channel_id")
    GUILD_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    channel_id: int
    def __init__(self, guild_id: _Optional[int] = ..., name: _Optional[str] = ..., channel_id: _Optional[int] = ...) -> None: ...
